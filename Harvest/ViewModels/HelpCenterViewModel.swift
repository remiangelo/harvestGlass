...
final class HelpCenterViewModel {
    ...
    static let faqs: [FAQ] = [
        ...
        FAQ(question: "What is Mindful Messaging?", answer: "Mindful Messaging analyzes your messages before sending to flag potentially concerning language. It provides growth lessons to help build healthier communication habits. Gold subscribers can disable this feature.", category: "Features"),
